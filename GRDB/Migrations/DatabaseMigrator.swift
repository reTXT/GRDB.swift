...
public struct DatabaseMigrator {
    ...
    public mutating func registerMigration(_ identifier: String, withDisabledForeignKeyChecks disabledForeignKeyChecks: Bool = false, migrate: (Database) throws -> Void) {
